...
from trainer_baseline import SelectedUserTrainer


def evaluate(model_name, dataset_name, pretrained_file, **kwargs):
    # configurations initialization
    props = [
        f'props/Rank.yaml', f'props/{dataset_name}.yaml', 'openai_api.yaml',
        'props/overall.yaml'
    ]
    print(props)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", type=str, default="Rl", help="model name")
    parser.add_argument('-d', type=str, default='lastfm', help='dataset name')
